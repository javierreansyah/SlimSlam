    ...
    <div class="relative min-h-screen flex justify-center ">
        <div class="relative w-full">
            <header class="container fixed start-0 top-0 items-center gap-2 py-10 lg:grid-cols-3 bg-black">
                @if (Route::has('login'))
                    <nav class="container mx-3 flex flex-1 justify-end top-0 right-0 left-0 bg-green-300">
                        ...
                        <div class="flex items-center gap-4 bg-green-500 text-white hover:bg-green-900">
